...
import it.unimi.evotion.tasks.bkmeans.Task;
...
public class bkMeansTask implements Task {
   ...
   // private Dataset<Row> dfResult3;
     ...
     *      args[2] url_json|url_csv result of Bisecting KMeans information
     * @throws Exception
     */
    @Override
    public void init(Object... args) throws Exception {

        this.logger = LogManager.getLogger(bkMeansTask.class);
    ...
    public void run(Object... params) throws Exception {
        ...
        BisectingKMeans bkm = new BisectingKMeans().setK(Integer.parseInt(this.k)).setSeed(1);
