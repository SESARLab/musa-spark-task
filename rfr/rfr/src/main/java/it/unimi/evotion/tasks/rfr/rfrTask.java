...
import it.unimi.evotion.tasks.rfr.Task;
import it.unimi.evotion.tasks.rfr.rfTreeStruct;
...
public class rfrTask implements Task {
    ...
    public void init(Object... args) throws Exception {
        ...
        this.logger = LogManager.getLogger(rfrTask.class);
...
*/
    private void rfRegression(){
        VectorIndexerModel featureIndexer = new VectorIndexer()
                .setInputCol("features")
                .setOutputCol("indexedFeatures")
                .setMaxCategories(Integer.parseInt(this.maxCat))
                .fit(df);
