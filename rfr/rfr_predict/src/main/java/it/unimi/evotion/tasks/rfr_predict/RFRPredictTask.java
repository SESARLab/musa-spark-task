...
import it.unimi.evotion.tasks.rfr_predict.Task;
import it.unimi.evotion.tasks.rfr_predict.rfTreeStruct;
...
public class RFRPredictTask implements Task {
    ...
    // ----------------------------------------------------------------------
    /**
     * Create the RandomForestTree Predict
     *
    ...
    public void init(Object... args) throws Exception {
        ...
        this.logger = LogManager.getLogger(RFRPredictTask.class);
...
// Select (prediction, true label) and compute test error
    ...
    private void createResults(){
        ...
        List<Row> rows2 = Arrays.asList(RowFactory.create(rmse));
