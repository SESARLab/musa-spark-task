...
import it.unimi.evotion.tasks.rfr_model.Task;
...
public class RFRModelTask implements Task {
    ...
    */
    ...
    public void init(Object... args) throws Exception {
        ...
        this.logger = LogManager.getLogger(RFRModelTask.class);
...
*/
    ...
    public void run(Object... params) throws Exception {
        ...
        RandomForestRegressor rf = new RandomForestRegressor()
                ...
                .setFeatureSubsetStrategy(parameters.getOrDefault("fss", fss)); //Accessor for supported featureSubsetStrategy settings: auto, all, onethird,
                //.setNumTrees(Integer.parseInt(parameters.getOrDefault("maxBins", String.valueOf(20))));
