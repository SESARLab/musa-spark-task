...
L'obiettivo di questa tesi è quello di recuperare algoritmi di machine learning per l'analisi dati sviluppati come \emph{Spark tasks} in linguaggio Java, e studiare l'implementazione di nuovi algoritmi seguendo un approccio più moderno, quindi utilizzando il linguaggio \emph{Python} e la libreria \emph{Tensorflow}; l'esecuzione avviene in un contesto distribuito gestito dall'orchestratore \emph{Kubernetes}.
