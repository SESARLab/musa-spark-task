...
\chapter{Deployment sull'infrastruttura distribuita finale}\label{ch:musa}
    ...
    \section{Processo di deployment}
        ...
        Di seguito si analizza l'esecuzione dell'algoritmo Linear Regression utilizzando un'immagine Docker che contiene l'uber jar del task e il dataset da utilizzare, i risultati vengono scritti nella cartella RESULT del Pod stesso.
        \begin{lstlisting}[numbers=none]
        spark-submit \
