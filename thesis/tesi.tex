...
\chapter{Le tecnologie per l'analisi dati e il calcolo distribuito}\label{ch:tec}
    ...
    Gli algoritmi predittivi possono essere utilizzati sia per assegnare i dati a specifiche categorie predeterminate (classification), sia per identificare le relazioni presenti fra le diverse variabili (regression).
